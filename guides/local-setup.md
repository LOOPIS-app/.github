...
3. Go to **My Sites > Network Admin > Plugins** and click **Add plugin > Upload plugin > Choose file** to install + activate **LOOPIS Config**.
...
4. Use a terminal to create **symbolic links**[^1] for the folders you moved and place them in the Local WP folders:

| Folder name | Symbolic link location |
|---|---|
| loopis-theme | `...app/public/wp-content/themes/` |
| loopis-_plugin_ | `...app/public/wp-content/plugins/` |
