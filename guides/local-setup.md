...
3. Click **Plugins > Add plugin > Upload plugin > Choose file** to install + activate **LOOPIS Config**.
...
3. For the LOOPIS components you want to review or develop, add the folders below from your Local WP installation to your IDE workspace.
